...
void ADSREditor::EnvelopeData::drawDebugInformation(Graphics& g, Rectangle<float> area) const
{
...
void ADSREditor::EnvelopeData::show(Graphics& g, const String& title, float value, Rectangle<float>& area) const
{
